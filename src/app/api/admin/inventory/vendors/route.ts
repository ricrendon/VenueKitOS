...
import { mockInventoryVendors } from "@/lib/mock/data";
...
export async function GET() {
  if (isDemoMode()) return NextResponse.json(mockInventoryVendors);
  try {
...
export async function POST(request: NextRequest) {
  if (isDemoMode()) return NextResponse.json({ success: true, vendor: { id: "demo-vendor-new" } });
  try {
